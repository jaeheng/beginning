...
<div class="product">
    <div class="jumbotron" style="background-color: #07111B;">
        <div class="container">
            ...
            <p class="slogan">简洁大方，多种布局可供选择,非常适合个人博客,兼容官方Emlog6.0.0 <br />最新更新日期: 2020/03/13 </p>
            <a href="https://pan.baidu.com/s/1YzDtpv4gUTANBsTVI4SQPg" target="_blank" class="btn btn-blue">立即下载</a>
            <span class="version">当前版本 v2.6</span>
